/* autogenerated by Processing revision 1286 on 2023-04-08 */
...
price = abs(price);
 ...
 public void oilPrice(int priceFunction) {
  ...
  if (time != lastTime) {
    ...
    case 0:
      priceDelta = PApplet.parseInt (random(-2, 3));
    ...
    lastTime = time;
    priceDelta =round2((sellInfluence * sellDelta) + sign * 8* 0.175f * priceDer(a1, a2, a3, b1, b2, b3, c1, c2, c3, time));
    lastPrice = priceDelta;
    oilPrice += priceDelta;
